...
const file_proto_example_v1_example_proto_rawDesc = "" +
	...
	"\rCreateExample\x12 .example.v1.CreateExampleRequest\x1a!.example.v1.CreateExampleResponseB\xc4\x01\n" +
	"\x0ecom.example.v1B\fExampleProtoP\x01Z[github.com/redpanda-data/protoc-gen-go-mcp/examples/basic/gen/go/proto/example/v1;examplev1\xa2\x02\x03EXX\xaa\x02\n" +
	"Example.V1\xca\x02\n" +
