...
import (
	_go "github.com/redpanda-data/protoc-gen-go-mcp/pkg/testdata/gen/go"
)
...
type TestServiceServer interface {
	CreateItem(ctx context.Context, req *_go.CreateItemRequest) (*_go.CreateItemResponse, error)
	GetItem(ctx context.Context, req *_go.GetItemRequest) (*_go.GetItemResponse, error)
	ProcessWellKnownTypes(ctx context.Context, req *_go.ProcessWellKnownTypesRequest) (*_go.ProcessWellKnownTypesResponse, error)
}
...
func RegisterTestServiceHandler(s *mcpserver.MCPServer, srv TestServiceServer) {
	...
	s.AddTool(TestService_ProcessWellKnownTypesTool, func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		var req _go.ProcessWellKnownTypesRequest
...
type TestServiceClient interface {
	CreateItem(ctx context.Context, req *_go.CreateItemRequest, opts ...grpc.CallOption) (*_go.CreateItemResponse, error)
	GetItem(ctx context.Context, req *_go.GetItemRequest, opts ...grpc.CallOption) (*_go.GetItemResponse, error)
	ProcessWellKnownTypes(ctx context.Context, req *_go.ProcessWellKnownTypesRequest, opts ...grpc.CallOption) (*_go.ProcessWellKnownTypesResponse, error)
}

// ConnectTestServiceClient is compatible with the connectrpc-go client interface.
type ConnectTestServiceClient interface {
	CreateItem(ctx context.Context, req *connect.Request[_go.CreateItemRequest]) (*connect.Response[_go.CreateItemResponse], error)
	GetItem(ctx context.Context, req *connect.Request[_go.GetItemRequest]) (*connect.Response[_go.GetItemResponse], error)
	ProcessWellKnownTypes(ctx context.Context, req *connect.Request[_go.ProcessWellKnownTypesRequest]) (*connect.Response[_go.ProcessWellKnownTypesResponse], error)
}
