...
func (c *testServiceClient) CreateItem(ctx context.Context, in *CreateItemRequest, opts ...grpc.CallOption) (*CreateItemResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/testdata.TestService/CreateItem", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *testServiceClient) GetItem(ctx context.Context, in *GetItemRequest, opts ...grpc.CallOption) (*GetItemResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/testdata.TestService/GetItem", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *testServiceClient) ProcessWellKnownTypes(ctx context.Context, in *ProcessWellKnownTypesRequest, opts ...grpc.CallOption) (*ProcessWellKnownTypesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/testdata.TestService/ProcessWellKnownTypes", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _TestService_CreateItem_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/testdata.TestService/CreateItem",
	}
...
func _TestService_GetItem_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/testdata.TestService/GetItem",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TestService_ProcessWellKnownTypes_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/testdata.TestService/ProcessWellKnownTypes",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
