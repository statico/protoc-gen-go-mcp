...
func RegisterTestServiceHandler(s *mcpserver.MCPServer, srv TestServiceServer) {
  s.AddTool(TestService_CreateItemTool, func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
    var req testservice.v1.CreateItemRequest
  ...
  s.AddTool(TestService_GetItemTool, func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
    var req testservice.v1.GetItemRequest
...
type TestServiceClient interface {
  CreateItem(ctx context.Context, req *testservice.v1.CreateItemRequest, opts ...grpc.CallOption) (*testservice.v1.CreateItemResponse, error)
  GetItem(ctx context.Context, req *testservice.v1.GetItemRequest, opts ...grpc.CallOption) (*testservice.v1.GetItemResponse, error)
}

// ConnectTestServiceClient is compatible with the connectrpc-go client interface.
type ConnectTestServiceClient interface {
  CreateItem(ctx context.Context, req *connect.Request[testservice.v1.CreateItemRequest]) (*connect.Response[testservice.v1.CreateItemResponse], error)
  GetItem(ctx context.Context, req *connect.Request[testservice.v1.GetItemRequest]) (*connect.Response[testservice.v1.GetItemResponse], error)
}
