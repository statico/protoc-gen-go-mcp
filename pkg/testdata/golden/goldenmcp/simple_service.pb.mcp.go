...
type SimpleServiceClient interface {
	Echo(ctx context.Context, req *golden.EchoRequest, opts ...grpc.CallOption) (*golden.EchoResponse, error)
}
...
type ConnectSimpleServiceClient interface {
	Echo(ctx context.Context, req *connect.Request[golden.EchoRequest]) (*connect.Response[golden.EchoResponse], error)
}
