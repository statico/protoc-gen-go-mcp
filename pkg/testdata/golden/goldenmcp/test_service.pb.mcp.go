...
import (
	golden "github.com/redpanda-data/protoc-gen-go-mcp/pkg/testdata/golden"
)
...
type TestServiceServer interface {
	CreateItem(ctx context.Context, req *golden.CreateItemRequest) (*golden.CreateItemResponse, error)
	GetItem(ctx context.Context, req *golden.GetItemRequest) (*golden.GetItemResponse, error)
	ProcessWellKnownTypes(ctx context.Context, req *golden.ProcessWellKnownTypesRequest) (*golden.ProcessWellKnownTypesResponse, error)
}
...
func RegisterTestServiceHandler(s *mcpserver.MCPServer, srv TestServiceServer) {
	s.AddTool(TestService_CreateItemTool, func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		var req golden.CreateItemRequest
	...
	s.AddTool(TestService_ProcessWellKnownTypesTool, func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		var req golden.ProcessWellKnownTypesRequest
...
type TestServiceClient interface {
	CreateItem(ctx context.Context, req *golden.CreateItemRequest, opts ...grpc.CallOption) (*golden.CreateItemResponse, error)
	GetItem(ctx context.Context, req *golden.GetItemRequest, opts ...grpc.CallOption) (*golden.GetItemResponse, error)
	ProcessWellKnownTypes(ctx context.Context, req *golden.ProcessWellKnownTypesRequest, opts ...grpc.CallOption) (*golden.ProcessWellKnownTypesResponse, error)
}

// ConnectTestServiceClient is compatible with the connectrpc-go client interface.
type ConnectTestServiceClient interface {
	CreateItem(ctx context.Context, req *connect.Request[golden.CreateItemRequest]) (*connect.Response[golden.CreateItemResponse], error)
	GetItem(ctx context.Context, req *connect.Request[golden.GetItemRequest]) (*connect.Response[golden.GetItemResponse], error)
	ProcessWellKnownTypes(ctx context.Context, req *connect.Request[golden.ProcessWellKnownTypesRequest]) (*connect.Response[golden.ProcessWellKnownTypesResponse], error)
}
