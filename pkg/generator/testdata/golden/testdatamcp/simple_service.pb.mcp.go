...
type SimpleServiceServer interface {
	Echo(ctx context.Context, req *testdata.EchoRequest) (*testdata.EchoResponse, error)
}
...
type SimpleServiceClient interface {
	Echo(ctx context.Context, req *testdata.EchoRequest, opts ...grpc.CallOption) (*testdata.EchoResponse, error)
}
...
type ConnectSimpleServiceClient interface {
	Echo(ctx context.Context, req *connect.Request[testdata.EchoRequest]) (*connect.Response[testdata.EchoResponse], error)
}
